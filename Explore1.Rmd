...
### Loading data
Load data and format some attribute variables
```{r}
...
coupon_visit_train <- read.csv(paste0(dir,"coupon_visit_train.csv"), as.is=T, nrows=100000)
...
barplot(weekcounts, main="Coupon Visit/Purchase Counts by the Week",
        ylab="Count", xlab="Week", cex.names=0.8, ylim=c(0,3500), col=c("grey", "blue"))
legend("topleft", c("Purchase", "No Purchase"), cex=1.0, fill=c("blue","grey"))
```
.   
